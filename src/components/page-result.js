      ...
      <Card className="mb-3">
        <Card.Body>
          ...
          <Row className="row-cols-auto justify-content-center">
            <Col>
              <Button as="a" type="button" variant="outline-info" className="me-1" href={`https://twitter.com/intent/tweet?text=今日のランチは「${result.display_name}」にします&hashtags=霞が関ランチ&url=${encodeURIComponent('https://tani-cat.github.io/kasumigaseki-lunch/')}`} target="_blank" rel="nofollow">Tweet</Button>
            </Col>
            <Col>
